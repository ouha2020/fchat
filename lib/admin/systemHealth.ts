...
const REQUIRED_TABLES: ExpectedTable[] = [
  ...
  {
    name: "family_schedule_collaboration_push_claims",
    migrationName: "schedule_collaboration_push_claims",
    impact: "日程协作通知可能被重复发送，或无法验证通知对应的真实操作。",
  },
...
const REQUIRED_FUNCTIONS: ExpectedFunction[] = [
  ...
  fn(
    "ensure_schedule_reminder_deliveries",
    ["p_schedule_item_id uuid"],
    "schedule_reminder_rule_consistency",
    false,
  ),
  fn(
    "get_schedule_reminder_status_for_member",
    ["p_schedule_item_id uuid"],
    "schedule_reminder_rule_consistency",
  ),
  ...
  fn("ensure_overdue_schedule_reminders", [], "schedule_reminder_stale_guard", false),
  ...
  fn("update_assistant_action_card", ["p_card_id uuid"], "assistant_card_edit"),
  fn("delete_assistant_action_card", ["p_card_id uuid"], "assistant_card_delete"),
...
const REQUIRED_TRIGGERS = [
  ...
  },
  {
    ...
    migrationName: "schedule_reminder_rule_consistency",
