...
-- inherited from message_recipients like list_messages_for_member.
...
-- Personal photo albums curated from public chat images (see
-- supabase/migrations/20260705_personal_albums.sql).
...
-- Edit a pending assistant action card in place (see
-- supabase/migrations/20260709_assistant_card_edit.sql).
